...
import { ModuleCyber06Component } from 'app/entities/module-cyber-06/module-cyber-06.component';
...
describe('Component Tests', () => {
  describe('ModuleCyber06 Management Component', () => {
    let comp: ModuleCyber06Component;
    let fixture: ComponentFixture<ModuleCyber06Component>;
    let service: ModuleCyber06Service;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [AppJhipsterTestModule],
        declarations: [ModuleCyber06Component],
        providers: [
          {
        ...
        .overrideTemplate(ModuleCyber06Component, '')
        .compileComponents();

      fixture = TestBed.createComponent(ModuleCyber06Component);
